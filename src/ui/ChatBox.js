...
const LOCAL_PATTERNS = [
  ...
  { re: /^(attack|fight|kill)$/i, commands: [{ task: 'attack_nearest_enemy' }], reply: null },
  { re: /\b(attack|fight|kill)\b.*\b(enemy|enemies|threat|threats|them)\b/i, commands: [{ task: 'attack_nearest_enemy' }], reply: null },
  { re: /^(be autonomous|be independent|do your own thing|go do your own thing|go explore|explore|wander)$/i, commands: [{ task: 'wander_explore' }], reply: null },
  { re: /^(defend|protect|guard)$/i, commands: [{ task: 'defend_player' }], reply: null },
  { re: /\babsorb\b/i, commands: [{ task: 'absorb_npc' }], reply: null },
